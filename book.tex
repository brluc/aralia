...
\title{The Title}
\posttitle{\par{\normalfont\normalsize\scshape the subtitle}\end{center}}
\author{The Author}
...
%% I'll try to make it like this title page soon.
%% 
%%  \begin{titlepage}
%% 	\begin{center}
%% 	\huge{\bfseries LES NOMS DE NOS PLANTES} \\
%% 	[4cm]
%% 	\textsc{\LARGE SBL Bushcraft Project} \\
%% 	[2cm]
%% 	\textsc{\Large Mars 2019} \\
%% 	[2cm]
%% 	\textsc{\Large 3e édition} \\
%% 	\end{center}
%% \end{titlepage}
